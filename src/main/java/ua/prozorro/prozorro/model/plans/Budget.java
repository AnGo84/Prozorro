...
public class Budget {
	...
	public boolean equals(Object o) {
		...
		if (amountNet != null ? !amountNet.equals(budget.amountNet) : budget.amountNet != null) return false;
		if (description != null ? !description.equals(budget.description) : budget.description != null) return false;
		if (notes != null ? !notes.equals(budget.notes) : budget.notes != null) return false;
		if (project != null ? !project.equals(budget.project) : budget.project != null) return false;
		if (currency != null ? !currency.equals(budget.currency) : budget.currency != null) return false;
		if (amount != null ? !amount.equals(budget.amount) : budget.amount != null) return false;
