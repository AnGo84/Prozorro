...
public class Plan {
    ...
    public boolean equals(Object o) {
        ...
        if (documents != null ? !documents.equals(plan.documents) : plan.documents != null) return false;
        if (classification != null ? !classification.equals(plan.classification) : plan.classification != null)
            return false;
        if (items != null ? !items.equals(plan.items) : plan.items != null) return false;
        if (budget != null ? !budget.equals(plan.budget) : plan.budget != null) return false;
        if (additionalClassifications != null ? !additionalClassifications.equals(plan.additionalClassifications) : plan.additionalClassifications != null)
            return false;
        if (procuringEntity != null ? !procuringEntity.equals(plan.procuringEntity) : plan.procuringEntity != null)
            return false;
        if (tender != null ? !tender.equals(plan.tender) : plan.tender != null) return false;
        if (datePublished != null ? !datePublished.equals(plan.datePublished) : plan.datePublished != null)
            return false;
        if (owner != null ? !owner.equals(plan.owner) : plan.owner != null) return false;
