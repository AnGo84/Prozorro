...
public class TenderOld {
    ...
    public void setItemList(List<ItemOld> itemList) {
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("tenders.TenderOld{");
