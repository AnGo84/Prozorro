...
public class Contract {
    ...
    public boolean equals(Object o) {
        ...
        if (items != null ? !items.equals(contract.items) : contract.items != null) return false;
        if (suppliers != null ? !suppliers.equals(contract.suppliers) : contract.suppliers != null) return false;
        if (value != null ? !value.equals(contract.value) : contract.value != null) return false;
        if (awardID != null ? !awardID.equals(contract.awardID) : contract.awardID != null) return false;
        if (contractID != null ? !contractID.equals(contract.contractID) : contract.contractID != null) return false;
        if (documents != null ? !documents.equals(contract.documents) : contract.documents != null) return false;
        if (tenderId != null ? !tenderId.equals(contract.tenderId) : contract.tenderId != null) return false;
        ...
        if (contractNumber != null ? !contractNumber.equals(contract.contractNumber) : contract.contractNumber != null)
            return false;
        if (period != null ? !period.equals(contract.period) : contract.period != null) return false;
        if (dateSigned != null ? !dateSigned.equals(contract.dateSigned) : contract.dateSigned != null) return false;
        if (dateModified != null ? !dateModified.equals(contract.dateModified) : contract.dateModified != null)
            return false;
        if (procuringEntity != null ? !procuringEntity.equals(contract.procuringEntity) : contract.procuringEntity != null)
            return false;
        if (owner != null ? !owner.equals(contract.owner) : contract.owner != null) return false;
