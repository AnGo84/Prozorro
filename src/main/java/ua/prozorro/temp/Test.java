...
public class Test {
	...
	public static void main(String[] args) {
		...
		try {
			Date dateFrom = DateUtils.parseDateFromString("2016-11-05", short_date_formate);
			Date dateTill = DateUtils.parseDateFromString("2016-11-05", short_date_formate);
	...
	private static void checkDataForPeriod(Date dateFrom, Date dateTill) {
		...
		try {
			...
			List<ProzorroPageContent> list = pageServiceProzorro
					                                 .getPagesList(DataType.TENDERS, dateFrom, dateTill, false);
