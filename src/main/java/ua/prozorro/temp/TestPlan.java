...
public class TestPlan {
	...
	public static void main(String[] args) {
		...
		String url2 = "https://public.api.openprocurement.org/api/2.4/plans?offset=2018-11-30T21%3A00%3A03.340891%2B03%3A00";
	...
	private static void GSONPareser(String url) {
		try {
			...
			System.out
					.println(new Date() + ": Total page count: " + pageContent + " with plans count: " + tenderCount);
