...
public class PlanSourceLinkBuilder extends AbstractSourceLinkBuilder {
	...
	public SourceLink getSourceLink() {
		String startPage =
				PropertiesUtils.getPropertyString(properties, AppProperty.PLAN_START_PAGE.getPropertyName());
		
		String pageOffset =
				PropertiesUtils.getPropertyString(properties, AppProperty.PLAN_PAGE_OFFSET.getPropertyName());
		...
		SourceLink sourceLink =
				SourceLink.builder().type(SourceType.PROZORRO_PLAN).startPage(startPage).urlPatternOnDate(pageOnDate)
