...
public class PlanSourceLinkBuilder extends AbstractSourceLinkBuilder {
	...
	public SourceLink getSourceLink() {
		String startPage = PropertiesUtils.getPropertyString(properties,
															 AppPropertyKey.PLAN_START_PAGE.getPropertyName());
		
		String pageOffset = PropertiesUtils.getPropertyString(properties,
															  AppPropertyKey.PLAN_PAGE_OFFSET.getPropertyName());
		String pageEnd = PropertiesUtils.getPropertyString(properties, AppPropertyKey.PLAN_PAGE_END.getPropertyName());
