...
public class TenderSourceLinkBuilder extends AbstractSourceLinkBuilder {
	...
	public SourceLink getSourceLink() {
		String startPage =
				PropertiesUtils.getPropertyString(properties, AppProperty.TENDER_START_PAGE.getPropertyName());
		
		String pageOffset =
				PropertiesUtils.getPropertyString(properties, AppProperty.TENDER_PAGE_OFFSET.getPropertyName());
		...
		SourceLink sourceLink =
				SourceLink.builder().type(SourceType.PROZORRO_TENDER).startPage(startPage).urlPatternOnDate(pageOnDate)
