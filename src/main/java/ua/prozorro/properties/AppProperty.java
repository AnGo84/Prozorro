...
public enum AppProperty {
    ...
    //
    CONTRACT_START_PAGE("prozorro.contract.start_page"), CONTRACT_PAGE_LIMIT(
            "prozorro.contract.page_limit"), CONTRACT_PAGE_LIMIT_VALUE(
            "prozorro.contract.page_limit_value"), CONTRACT_PAGE_OFFSET(
    ...
    DATE_FORMAT("prozorro.date_formate"), SHORT_DATE_FORMAT("prozorro.short_date_formate"),
    //
    NBU_START_PAGE("nbu.exchangerates.start_page"), NBU_PAGE_PREFIX("nbu.exchangerates.page_prefix"),
    NBU_PAGE_END("nbu.exchangerates.page_end"), NBU_DATE_FORMAT("nbu.exchangerates.date_format")
    //
    ;
