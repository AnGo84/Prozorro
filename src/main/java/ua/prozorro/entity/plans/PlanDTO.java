...
public class PlanDTO {
	...
	public boolean equals(Object o) {
		...
		if (id != null ? !id.equals(planDTO.id) : planDTO.id != null)
			return false;
		if (planID != null ? !planID.equals(planDTO.planID) : planDTO.planID != null)
			return false;
		if (documents != null ? !documents.equals(planDTO.documents) : planDTO.documents != null)
			return false;
		if (classification != null ? !classification.equals(planDTO.classification) : planDTO.classification != null)
			return false;
		if (items != null ? !items.equals(planDTO.items) : planDTO.items != null)
			return false;
		if (budget != null ? !budget.equals(planDTO.budget) : planDTO.budget != null)
			return false;
		if (additionalClassifications != null ? !additionalClassifications.equals(planDTO.additionalClassifications) :
				planDTO.additionalClassifications != null)
			return false;
		if (procuringEntity != null ? !procuringEntity.equals(planDTO.procuringEntity) :
				planDTO.procuringEntity != null)
			return false;
		if (tender != null ? !tender.equals(planDTO.tender) : planDTO.tender != null)
			return false;
		if (datePublished != null ? !datePublished.equals(planDTO.datePublished) : planDTO.datePublished != null)
			return false;
		if (owner != null ? !owner.equals(planDTO.owner) : planDTO.owner != null)
			return false;
