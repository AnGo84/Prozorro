...
public class PlanJSONDTO {
	...
	public PlanJSONDTO(String id, String dateModified) {
		this.id = id;
		this.dateModified = dateModified;
	}
	
	public PlanJSONDTO(String id, String dateModified, String model) {
		this.id = id;
		this.dateModified = dateModified;
		this.model = model;
	}
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof PlanJSONDTO))
			return false;
		
		PlanJSONDTO that = (PlanJSONDTO) o;
	...
	public String toString() {
		final StringBuilder sb = new StringBuilder("PlanJSONDTO{");
