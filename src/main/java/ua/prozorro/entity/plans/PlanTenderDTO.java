...
public class PlanTenderDTO {
	...
	public boolean equals(Object o) {
		...
		if (id != null ? !id.equals(that.id) : that.id != null)
			return false;
		if (procurementMethod != null ? !procurementMethod.equals(that.procurementMethod) :
				that.procurementMethod != null)
			return false;
		if (procurementMethodType != null ? !procurementMethodType.equals(that.procurementMethodType) :
				that.procurementMethodType != null)
			return false;
		if (tenderPeriodStartDate != null ? !tenderPeriodStartDate.equals(that.tenderPeriodStartDate) :
				that.tenderPeriodStartDate != null)
			return false;
		if (tenderPeriodClarificationsUntil != null ?
				!tenderPeriodClarificationsUntil.equals(that.tenderPeriodClarificationsUntil) :
				that.tenderPeriodClarificationsUntil != null)
			return false;
		if (tenderPeriodEndDate != null ? !tenderPeriodEndDate.equals(that.tenderPeriodEndDate) :
				that.tenderPeriodEndDate != null)
			return false;
		return tenderPeriodInvalidationDate != null ?
				tenderPeriodInvalidationDate.equals(that.tenderPeriodInvalidationDate) :
				that.tenderPeriodInvalidationDate == null;
	}
