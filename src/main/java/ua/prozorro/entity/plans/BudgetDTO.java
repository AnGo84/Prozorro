...
public class BudgetDTO {
	...
	public boolean equals(Object o) {
		...
		if (id != null ? !id.equals(budgetDTO.id) : budgetDTO.id != null)
			return false;
		if (amountNet != null ? !amountNet.equals(budgetDTO.amountNet) : budgetDTO.amountNet != null)
			return false;
		if (description != null ? !description.equals(budgetDTO.description) : budgetDTO.description != null)
			return false;
		if (notes != null ? !notes.equals(budgetDTO.notes) : budgetDTO.notes != null)
			return false;
		if (project != null ? !project.equals(budgetDTO.project) : budgetDTO.project != null)
			return false;
		if (currency != null ? !currency.equals(budgetDTO.currency) : budgetDTO.currency != null)
			return false;
		if (amount != null ? !amount.equals(budgetDTO.amount) : budgetDTO.amount != null)
			return false;
