...
public class ItemDTO {
	...
	public boolean equals(Object o) {
		...
		if (quantity != itemDTO.quantity) return false;
		...
		if (classification != null ? !classification.equals(itemDTO.classification) : itemDTO.classification != null)
			return false;
		if (deliveryAddress != null ? !deliveryAddress.equals(itemDTO.deliveryAddress) : itemDTO.deliveryAddress != null)
			return false;
		if (deliveryStartDate != null ? !deliveryStartDate.equals(itemDTO.deliveryStartDate) : itemDTO.deliveryStartDate != null)
			return false;
		if (deliveryClarificationsUntil != null ? !deliveryClarificationsUntil.equals(itemDTO.deliveryClarificationsUntil) : itemDTO.deliveryClarificationsUntil != null)
			return false;
		if (deliveryEndDate != null ? !deliveryEndDate.equals(itemDTO.deliveryEndDate) : itemDTO.deliveryEndDate != null)
			return false;
		if (deliveryInvalidationDate != null ? !deliveryInvalidationDate.equals(itemDTO.deliveryInvalidationDate) : itemDTO.deliveryInvalidationDate != null)
			return false;
