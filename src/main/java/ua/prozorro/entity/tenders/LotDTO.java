...
public class LotDTO {
	...
	public boolean equals(Object o) {
		...
		if (title != null ? !title.equals(lotDTO.title) : lotDTO.title != null) return false;
		if (description != null ? !description.equals(lotDTO.description) : lotDTO.description != null) return false;
		if (currency != null ? !currency.equals(lotDTO.currency) : lotDTO.currency != null) return false;
		if (amount != null ? !amount.equals(lotDTO.amount) : lotDTO.amount != null) return false;
		if (addedTaxIncluded != null ? !addedTaxIncluded.equals(lotDTO.addedTaxIncluded) : lotDTO.addedTaxIncluded != null)
			return false;
		if (guaranteeCurrency != null ? !guaranteeCurrency.equals(lotDTO.guaranteeCurrency) : lotDTO.guaranteeCurrency != null)
			return false;
		if (guaranteeAmount != null ? !guaranteeAmount.equals(lotDTO.guaranteeAmount) : lotDTO.guaranteeAmount != null)
			return false;
		if (date != null ? !date.equals(lotDTO.date) : lotDTO.date != null) return false;
		if (minimalStepCurrency != null ? !minimalStepCurrency.equals(lotDTO.minimalStepCurrency) : lotDTO.minimalStepCurrency != null)
			return false;
		if (minimalStepAmount != null ? !minimalStepAmount.equals(lotDTO.minimalStepAmount) : lotDTO.minimalStepAmount != null)
			return false;
		if (minimalStepValueAddedTaxIncluded != null ? !minimalStepValueAddedTaxIncluded.equals(lotDTO.minimalStepValueAddedTaxIncluded) : lotDTO.minimalStepValueAddedTaxIncluded != null)
			return false;
		if (auctionPeriodStartDate != null ? !auctionPeriodStartDate.equals(lotDTO.auctionPeriodStartDate) : lotDTO.auctionPeriodStartDate != null)
			return false;
		if (auctionPeriodClarificationsUntil != null ? !auctionPeriodClarificationsUntil.equals(lotDTO.auctionPeriodClarificationsUntil) : lotDTO.auctionPeriodClarificationsUntil != null)
			return false;
		if (auctionPeriodEndDate != null ? !auctionPeriodEndDate.equals(lotDTO.auctionPeriodEndDate) : lotDTO.auctionPeriodEndDate != null)
			return false;
		if (auctionPeriodInvalidationDate != null ? !auctionPeriodInvalidationDate.equals(lotDTO.auctionPeriodInvalidationDate) : lotDTO.auctionPeriodInvalidationDate != null)
			return false;
		if (auctionUrl != null ? !auctionUrl.equals(lotDTO.auctionUrl) : lotDTO.auctionUrl != null) return false;
