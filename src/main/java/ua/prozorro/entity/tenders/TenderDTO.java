...
public class TenderDTO {
	...
	@ManyToMany(fetch = FetchType.LAZY, cascade = {CascadeType.ALL})
	@JoinTable(name = "Tenders_Cancellations", joinColumns = {@JoinColumn(name = "tender_id")}, inverseJoinColumns = {
	...
	@ManyToMany(fetch = FetchType.LAZY, cascade = {CascadeType.ALL})
	@JoinTable(name = "Tenders_Lots", joinColumns = {@JoinColumn(name = "tender_id")}, inverseJoinColumns = {
			@JoinColumn(name = "lot_id")})
	private List<LotDTO> lots = null;

	@ManyToMany(fetch = FetchType.LAZY, cascade = {CascadeType.ALL})
	@JoinTable(name = "Tenders_Features", joinColumns = {@JoinColumn(name = "tender_id")}, inverseJoinColumns = {
	...
	public boolean equals(Object o) {
		...
		if (numberOfBids != tenderDTO.numberOfBids) return false;
		if (id != null ? !id.equals(tenderDTO.id) : tenderDTO.id != null) return false;
		if (guaranteeCurrency != null ? !guaranteeCurrency.equals(tenderDTO.guaranteeCurrency) : tenderDTO.guaranteeCurrency != null)
			return false;
		if (guaranteeAmount != null ? !guaranteeAmount.equals(tenderDTO.guaranteeAmount) : tenderDTO.guaranteeAmount != null)
			return false;
		if (date != null ? !date.equals(tenderDTO.date) : tenderDTO.date != null) return false;
		if (procurementMethod != null ? !procurementMethod.equals(tenderDTO.procurementMethod) : tenderDTO.procurementMethod != null)
			return false;
		if (awardPeriodStartDate != null ? !awardPeriodStartDate.equals(tenderDTO.awardPeriodStartDate) : tenderDTO.awardPeriodStartDate != null)
			return false;
		if (awardPeriodClarificationsUntil != null ? !awardPeriodClarificationsUntil.equals(tenderDTO.awardPeriodClarificationsUntil) : tenderDTO.awardPeriodClarificationsUntil != null)
			return false;
		if (awardPeriodEndDate != null ? !awardPeriodEndDate.equals(tenderDTO.awardPeriodEndDate) : tenderDTO.awardPeriodEndDate != null)
			return false;
		if (awardPeriodInvalidationDate != null ? !awardPeriodInvalidationDate.equals(tenderDTO.awardPeriodInvalidationDate) : tenderDTO.awardPeriodInvalidationDate != null)
			return false;
		if (complaintPeriodStartDate != null ? !complaintPeriodStartDate.equals(tenderDTO.complaintPeriodStartDate) : tenderDTO.complaintPeriodStartDate != null)
			return false;
		if (complaintPeriodClarificationsUntil != null ? !complaintPeriodClarificationsUntil.equals(tenderDTO.complaintPeriodClarificationsUntil) : tenderDTO.complaintPeriodClarificationsUntil != null)
			return false;
		if (complaintPeriodEndDate != null ? !complaintPeriodEndDate.equals(tenderDTO.complaintPeriodEndDate) : tenderDTO.complaintPeriodEndDate != null)
			return false;
		if (complaintPeriodInvalidationDate != null ? !complaintPeriodInvalidationDate.equals(tenderDTO.complaintPeriodInvalidationDate) : tenderDTO.complaintPeriodInvalidationDate != null)
			return false;
		if (auctionUrl != null ? !auctionUrl.equals(tenderDTO.auctionUrl) : tenderDTO.auctionUrl != null) return false;
		if (enquiryPeriodStartDate != null ? !enquiryPeriodStartDate.equals(tenderDTO.enquiryPeriodStartDate) : tenderDTO.enquiryPeriodStartDate != null)
			return false;
		if (enquiryPeriodClarificationsUntil != null ? !enquiryPeriodClarificationsUntil.equals(tenderDTO.enquiryPeriodClarificationsUntil) : tenderDTO.enquiryPeriodClarificationsUntil != null)
			return false;
		if (enquiryPeriodEndDate != null ? !enquiryPeriodEndDate.equals(tenderDTO.enquiryPeriodEndDate) : tenderDTO.enquiryPeriodEndDate != null)
			return false;
		if (enquiryPeriodInvalidationDate != null ? !enquiryPeriodInvalidationDate.equals(tenderDTO.enquiryPeriodInvalidationDate) : tenderDTO.enquiryPeriodInvalidationDate != null)
			return false;
		if (submissionMethod != null ? !submissionMethod.equals(tenderDTO.submissionMethod) : tenderDTO.submissionMethod != null)
			return false;
		if (procuringEntity != null ? !procuringEntity.equals(tenderDTO.procuringEntity) : tenderDTO.procuringEntity != null)
			return false;
		if (funders != null ? !funders.equals(tenderDTO.funders) : tenderDTO.funders != null) return false;
		if (owner != null ? !owner.equals(tenderDTO.owner) : tenderDTO.owner != null) return false;
		if (documents != null ? !documents.equals(tenderDTO.documents) : tenderDTO.documents != null) return false;
		if (title != null ? !title.equals(tenderDTO.title) : tenderDTO.title != null) return false;
		if (tenderID != null ? !tenderID.equals(tenderDTO.tenderID) : tenderDTO.tenderID != null) return false;
		if (dateModified != null ? !dateModified.equals(tenderDTO.dateModified) : tenderDTO.dateModified != null)
			return false;
		if (status != null ? !status.equals(tenderDTO.status) : tenderDTO.status != null) return false;
		if (tenderPeriodStartDate != null ? !tenderPeriodStartDate.equals(tenderDTO.tenderPeriodStartDate) : tenderDTO.tenderPeriodStartDate != null)
			return false;
		if (tenderPeriodClarificationsUntil != null ? !tenderPeriodClarificationsUntil.equals(tenderDTO.tenderPeriodClarificationsUntil) : tenderDTO.tenderPeriodClarificationsUntil != null)
			return false;
		if (tenderPeriodEndDate != null ? !tenderPeriodEndDate.equals(tenderDTO.tenderPeriodEndDate) : tenderDTO.tenderPeriodEndDate != null)
			return false;
		if (tenderPeriodInvalidationDate != null ? !tenderPeriodInvalidationDate.equals(tenderDTO.tenderPeriodInvalidationDate) : tenderDTO.tenderPeriodInvalidationDate != null)
			return false;
		if (contracts != null ? !contracts.equals(tenderDTO.contracts) : tenderDTO.contracts != null) return false;
		if (auctionPeriodStartDate != null ? !auctionPeriodStartDate.equals(tenderDTO.auctionPeriodStartDate) : tenderDTO.auctionPeriodStartDate != null)
			return false;
		if (auctionPeriodClarificationsUntil != null ? !auctionPeriodClarificationsUntil.equals(tenderDTO.auctionPeriodClarificationsUntil) : tenderDTO.auctionPeriodClarificationsUntil != null)
			return false;
		if (auctionPeriodEndDate != null ? !auctionPeriodEndDate.equals(tenderDTO.auctionPeriodEndDate) : tenderDTO.auctionPeriodEndDate != null)
			return false;
		if (auctionPeriodInvalidationDate != null ? !auctionPeriodInvalidationDate.equals(tenderDTO.auctionPeriodInvalidationDate) : tenderDTO.auctionPeriodInvalidationDate != null)
			return false;
		if (procurementMethodType != null ? !procurementMethodType.equals(tenderDTO.procurementMethodType) : tenderDTO.procurementMethodType != null)
			return false;
		if (awards != null ? !awards.equals(tenderDTO.awards) : tenderDTO.awards != null) return false;
		if (minimalStepCurrency != null ? !minimalStepCurrency.equals(tenderDTO.minimalStepCurrency) : tenderDTO.minimalStepCurrency != null)
			return false;
		if (minimalStepAmount != null ? !minimalStepAmount.equals(tenderDTO.minimalStepAmount) : tenderDTO.minimalStepAmount != null)
			return false;
		if (minimalStepValueAddedTaxIncluded != null ? !minimalStepValueAddedTaxIncluded.equals(tenderDTO.minimalStepValueAddedTaxIncluded) : tenderDTO.minimalStepValueAddedTaxIncluded != null)
			return false;
		if (items != null ? !items.equals(tenderDTO.items) : tenderDTO.items != null) return false;
		if (bids != null ? !bids.equals(tenderDTO.bids) : tenderDTO.bids != null) return false;
		if (cancellations != null ? !cancellations.equals(tenderDTO.cancellations) : tenderDTO.cancellations != null)
			return false;
		if (currency != null ? !currency.equals(tenderDTO.currency) : tenderDTO.currency != null) return false;
		if (amount != null ? !amount.equals(tenderDTO.amount) : tenderDTO.amount != null) return false;
		if (addedTaxIncluded != null ? !addedTaxIncluded.equals(tenderDTO.addedTaxIncluded) : tenderDTO.addedTaxIncluded != null)
			return false;
		...
		if (description != null ? !description.equals(tenderDTO.description) : tenderDTO.description != null)
			return false;
		if (lots != null ? !lots.equals(tenderDTO.lots) : tenderDTO.lots != null) return false;
		if (features != null ? !features.equals(tenderDTO.features) : tenderDTO.features != null) return false;
		if (questions != null ? !questions.equals(tenderDTO.questions) : tenderDTO.questions != null) return false;
	...
	public int hashCode() {
		...
		result = 31 * result + (enquiryPeriodClarificationsUntil != null ? enquiryPeriodClarificationsUntil.hashCode() : 0);
		...
		result = 31 * result + (auctionPeriodClarificationsUntil != null ? auctionPeriodClarificationsUntil.hashCode() : 0);
		...
		result = 31 * result + (minimalStepValueAddedTaxIncluded != null ? minimalStepValueAddedTaxIncluded.hashCode() : 0);
