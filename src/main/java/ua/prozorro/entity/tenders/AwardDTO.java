...
public class AwardDTO {
	...
	public boolean equals(Object o) {
		...
		if (eligible != awardDTO.eligible)
			return false;
		if (qualified != awardDTO.qualified)
			return false;
		if (id != null ? !id.equals(awardDTO.id) : awardDTO.id != null)
			return false;
		if (status != null ? !status.equals(awardDTO.status) : awardDTO.status != null)
			return false;
		if (documents != null ? !documents.equals(awardDTO.documents) : awardDTO.documents != null)
			return false;
		if (date != null ? !date.equals(awardDTO.date) : awardDTO.date != null)
			return false;
		if (bidId != null ? !bidId.equals(awardDTO.bidId) : awardDTO.bidId != null)
			return false;
		if (currency != null ? !currency.equals(awardDTO.currency) : awardDTO.currency != null)
			return false;
		if (amount != null ? !amount.equals(awardDTO.amount) : awardDTO.amount != null)
			return false;
		if (valueAddedTaxIncluded != null ? !valueAddedTaxIncluded.equals(awardDTO.valueAddedTaxIncluded) :
				awardDTO.valueAddedTaxIncluded != null)
			return false;
		if (complaintPeriodStartDate != null ? !complaintPeriodStartDate.equals(awardDTO.complaintPeriodStartDate) :
				awardDTO.complaintPeriodStartDate != null)
			return false;
		if (complaintPeriodClarificationsUntil != null ?
				!complaintPeriodClarificationsUntil.equals(awardDTO.complaintPeriodClarificationsUntil) :
				awardDTO.complaintPeriodClarificationsUntil != null)
			return false;
		if (complaintPeriodEndDate != null ? !complaintPeriodEndDate.equals(awardDTO.complaintPeriodEndDate) :
				awardDTO.complaintPeriodEndDate != null)
			return false;
		if (complaintPeriodInvalidationDate != null ?
				!complaintPeriodInvalidationDate.equals(awardDTO.complaintPeriodInvalidationDate) :
				awardDTO.complaintPeriodInvalidationDate != null)
			return false;
