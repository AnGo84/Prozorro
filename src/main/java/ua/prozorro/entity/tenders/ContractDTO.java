...
public class ContractDTO {
	...
	public boolean equals(Object o) {
		...
		if (contractNumber != null ? !contractNumber.equals(that.contractNumber) : that.contractNumber != null)
			return false;
		if (contractPeriodStartDate != null ? !contractPeriodStartDate.equals(that.contractPeriodStartDate) :
				that.contractPeriodStartDate != null)
			return false;
		if (contractPeriodClarificationsUntil != null ?
				!contractPeriodClarificationsUntil.equals(that.contractPeriodClarificationsUntil) :
				that.contractPeriodClarificationsUntil != null)
			return false;
		if (contractPeriodEndDate != null ? !contractPeriodEndDate.equals(that.contractPeriodEndDate) :
				that.contractPeriodEndDate != null)
			return false;
		if (contractPeriodInvalidationDate != null ?
				!contractPeriodInvalidationDate.equals(that.contractPeriodInvalidationDate) :
				that.contractPeriodInvalidationDate != null)
			return false;
		if (dateSigned != null ? !dateSigned.equals(that.dateSigned) : that.dateSigned != null)
			return false;
	...
	public int hashCode() {
		...
		result = 31 * result +
				 (contractPeriodClarificationsUntil != null ? contractPeriodClarificationsUntil.hashCode() : 0);
